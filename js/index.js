...
swal({
		title: "Hello World!!!",
		text: "Hello visitor, you have landed upon little webspace of mwveliz. I hope you're doing well."
...
// 		}).then((value)=>{
// 			if(value===true) { 
// 				window.open('/Resume_Miguel_Sawant.pdf');
// 			}
// 		})
// 	}
// });
...
function loadMoghysSays() {
	const mwvelizSaysInnerHtml = `<div class="col m6">
	...
	$('#mwvelizSays').html(mwvelizSaysInnerHtml);
}
